    ...
    return(
      <div className='topNavStyle'>
        ...
        <div className='flex-box' >
          ...
          <span onClick={(e) => this.activateTab(e.target.attributes[0].value)} value='everything' className={this.state.activeTab === 'everything' ? 'activeTab' : 'category'}>All Articles</span>
        </div>
      </div>
